/* Rainbow v1.2 rainbowco.de | included languages: haskell, csharp, go, smalltalk, java, coffeescript, generic, expl3, lua, html, scheme, css, shell, python, javascript, php, ruby, latex, c, d, plain-tex, r */
window.Rainbow=function(){function t(a){var b,c=a.getAttribute&&a.getAttribute("data-language")||0;if(!c)for(a=a.attributes,b=0;b<a.length;++b)if("data-language"===a[b].nodeName)return a[b].nodeValue;return c}function D(a){var b=t(a)||t(a.parentNode);if(!b){var c=/\blang(?:uage)?-(\w+)/;(a=a.className.match(c)||a.parentNode.className.match(c))&&(b=a[1])}return b}function E(a,b){for(var c in f[d]){c=parseInt(c,10);var e=f[d][c];if(a==c&&b==e?0:a<=c&&b>=e)delete f[d][c],delete k[d][c];e=f[d][c];if(a>=
c&&a<e||b>c&&b<e)return!0}return!1}function u(a,b){return'<span class="'+a.replace(/\./g," ")+(m?" "+m:"")+'">'+b+"</span>"}function v(a,b,c,e){if("undefined"===typeof a||null===a)e();else{var h=a.exec(c);if(h){++w;b.name||"string"!=typeof b.matches[0]||(b.name=b.matches[0],delete b.matches[0]);var n=h[0],g=h.index,x=h[0].length+g,l=function(){function h(){v(a,b,c,e)}0<w%100?h():setTimeout(h,0)};if(E(g,x))l();else{var p=y(b.matches),m=function(a,c,e){if(a>=c.length)e(n);else{var d=h[c[a]];if(d){var g=
b.matches[c[a]],l=g.language,f=g.name&&g.matches?g.matches:g,k=function(b,d,g){var f;f=0;var k;for(k=1;k<c[a];++k)h[k]&&(f+=h[k].length);d=g?u(g,d):d;n=n.substr(0,f)+n.substr(f).replace(b,d);m(++a,c,e)};l?q(d,l,function(a){k(d,a)}):"string"===typeof g?k(d,d,g):z(d,f.length?f:[f],function(a){k(d,a,g.matches?g.name:0)})}else m(++a,c,e)}};m(0,p,function(a){b.name&&(a=u(b.name,a));k[d]||(k[d]={},f[d]={});k[d][g]={replace:h[0],"with":a};f[d][g]=x;l()})}}else e()}}function y(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&
b.push(c);return b.sort(function(a,b){return b-a})}function z(a,b,c){function e(b,n){n<b.length?v(b[n].pattern,b[n],a,function(){e(b,++n)}):F(a,function(a){delete k[d];delete f[d];--d;c(a)})}++d;e(b,0)}function F(a,b){function c(a,b,e,f){if(e<b.length){++A;var l=b[e],m=k[d][l];a=a.substr(0,l)+a.substr(l).replace(m.replace,m["with"]);l=function(){c(a,b,++e,f)};0<A%250?l():setTimeout(l,0)}else f(a)}var e=y(k[d]);c(a,e,0,b)}function q(a,b,c){var e=p[b]||[],h=p[0]||[];b=B[b]?e:e.concat(h);z(a.replace(/</g,
"&lt;").replace(/>/g,"&gt;").replace(/&(?![\w\#]+;)/g,"&amp;"),b,c)}function r(a,b,c){if(b<a.length){var e=a[b],h=D(e);return-1<(" "+e.className+" ").indexOf(" rainbow ")||!h?r(a,++b,c):(h=h.toLowerCase(),e.className+=e.className?" rainbow":"rainbow",q(e.innerHTML,h,function(d){e.innerHTML=d;k={};f={};s&&s(e,h);setTimeout(function(){r(a,++b,c)},0)}))}c&&c()}function C(a,b){a=a&&"function"==typeof a.getElementsByTagName?a:document;var c=a.getElementsByTagName("pre"),e=a.getElementsByTagName("code"),
d,f=[],g=[];for(d=0;d<c.length;++d)c[d].getElementsByTagName("code").length?c[d].innerHTML=c[d].innerHTML.replace(/^\s+/,"").replace(/\s+$/,""):f.push(c[d]);for(d=0;d<e.length;++d)g.push(e[d]);r(g.concat(f),0,b)}var k={},f={},p={},B={},d=0,w=0,A=0,m,s;return{extend:function(a,b,c){1==arguments.length&&(b=a,a=0);B[a]=c;p[a]=b.concat(p[a]||[])},b:function(a){s=a},a:function(a){m=a},color:function(a,b,c){if("string"==typeof a)return q(a,b,c);if("function"==typeof a)return C(0,a);C(a,b)}}}();
document.addEventListener?document.addEventListener("DOMContentLoaded",Rainbow.color,!1):window.attachEvent("onload",Rainbow.color);Rainbow.onHighlight=Rainbow.b;Rainbow.addClass=Rainbow.a;Rainbow.extend("haskell",[{name:"comment",pattern:/\{\-\-[\s\S(\w+)]+[\-\-][\}$]/gm},{name:"comment",pattern:/\-\-(.*)/g},{matches:{1:"keyword",2:"support.namespace"},pattern:/\b(module)\s(\w+)\s[\(]?(\w+)?[\)?]\swhere/g},{name:"keyword.operator",pattern:/\+|\!|\-|&(gt|lt|amp);|\/\=|\||\@|\:|\.|\+{2}|\:|\*|\=|#|\.{2}|(\\)[a-zA-Z_]/g},{name:"keyword",pattern:/\b(case|class|foreign|hiding|qualified|data|family|default|deriving|do|else|if|import|in|infix|infixl|infixr|instance|let|in|otherwise|module|newtype|of|then|type|where)\b/g},
{name:"keyword",pattern:/[\`][a-zA-Z_']*?[\`]/g},{matches:{1:"keyword",2:"keyword.operator"},pattern:/\b(infix|infixr|infixl)+\s\d+\s(\w+)*/g},{name:"entity.class",pattern:/\b([A-Z][A-Za-z0-9_']*)/g},{name:"meta.preprocessor",matches:{1:[{matches:{1:"keyword.define",2:"entity.name"},pattern:/(\w+)\s(\w+)\b/g},{name:"keyword.define",pattern:/endif/g},{name:"constant.numeric",pattern:/\d+/g},{matches:{1:"keyword.include",2:"string"},pattern:/(include)\s(.*?)$/g}]},pattern:/^\#([\S\s]*?)$/gm}]);Rainbow.extend("csharp",[{name:"constant",pattern:/\b(false|null|true)\b/g},{name:"keyword",pattern:/\b(abstract|add|alias|ascending|as|base|bool|break|byte|case|catch|char|checked|class|const|continue|decimal|default|delegate|descending|double|do|dynamic|else|enum|event|explicit|extern|false|finally|fixed|float|foreach|for|from|get|global|goto|group|if|implicit|int|interface|internal|into|in|is|join|let|lock|long|namespace|new|object|operator|orderby|out|override|params|partial|private|protected|public|readonly|ref|remove|return|sbyte|sealed|select|set|short|sizeof|stackalloc|static|string|struct|switch|this|throw|try|typeof|uint|unchecked|ulong|unsafe|ushort|using|value|var|virtual|void|volatile|where|while|yield)\b/g},
...
{name:"constant.language",pattern:/true|false|null|string|byte|rune|u?int(8|16|32|64)?|float(32|64)|complex(64|128)/g},{name:"keyword.operator",pattern:/\+|\!|\-|&(gt|lt|amp);|\||\*|\:?=/g},{matches:{1:"function.call"},pattern:/(\w+?)(?=\()/g},{matches:{1:"storage.function",2:"entity.name.function"},pattern:/(func)\s(.*?)(?=\()/g}]);Rainbow.extend("smalltalk",[{name:"keyword.pseudovariable",pattern:/self|thisContext/g},{name:"keyword.constant",pattern:/false|nil|true/g},{name:"string",pattern:/'([^']|'')*'/g},{name:"string.symbol",pattern:/#\w+|#'([^']|'')*'/g},{name:"string.character",pattern:/\$\w+/g},{name:"comment",pattern:/"([^"]|"")*"/g},{name:"constant.numeric",pattern:/-?\d+(\.\d+)?((r-?|s)[A-Za-z0-9]+|e-?[0-9]+)?/g},{name:"entity.name.class",pattern:/\b[A-Z]\w*/g},{name:"entity.name.function",pattern:/\b[a-z]\w*:?/g},
...
{name:"constant.language",pattern:/true|false|null/g},{name:"keyword.operator",pattern:/\+|\!|\-|&(gt|lt|amp);|\||\*|\=/g},{matches:{1:"function.call"},pattern:/(\w+?)(?=\()/g},{matches:{1:"storage.function",2:"entity.name.function"},pattern:/(function)\s(.*?)(?=\()/g}]);Rainbow.extend("expl3",[{name:"comment",pattern:/%.*$/gm},{matches:{0:"entity.name.function",1:"entity.class",2:"tag"},pattern:/(\\(?:__)?[a-z]+_)[a-z_]+(:[nNpTFwcVvxof]*)/g},{matches:{0:"variable",1:"support",2:"entity.class"},pattern:/\\([cgl]__?)[a-z][a-z_]+(_[A-Za-z]+)/g},{name:"entity.name.function",pattern:/#\d/g},{name:"entity.name.function",pattern:/\\[A-Za-z]+/g},{matches:{0:"variable",1:"entity.name.function",2:"entity.class"},pattern:/[a-z\-]+\s+(\.[a-z_]+):([nNpTFwcVvxof]*)\s+=/g}],!0);Rainbow.extend("lua",[{matches:{1:{name:"keyword.operator",pattern:/\=/g},2:{name:"string",matches:{name:"constant.character.escape",pattern:/\\('|"){1}/g}}},pattern:/(\(|\s|\[|\=)(('|")([^\\\1]|\\.)*?(\3))/gm},{name:"comment",pattern:/\-{2}\[{2}\-{2}[\s\S]*?\-{2}\]{2}\-{2}|(\-{2})[\s\S]*?$/gm},{name:"constant.numeric",pattern:/\b(\d+(\.\d+)?(e(\+|\-)?\d+)?(f|d)?|0x[\da-f]+)\b/gi},{matches:{1:"keyword"},pattern:/\b((a|e)nd|in|repeat|break|local|return|do|for|then|else(if)?|function|not|if|or|until|while)(?=\(|\b)/gi},
...
{matches:{1:"keyword.operator.logical"},pattern:/[^\.]\b(and|not|or)\b/g},{matches:{1:"storage.function",2:"entity.name.function"},pattern:/(def)\s(.*?)(?=(\s|\())/g}],!0);Rainbow.extend("latex",[{name:"comment",pattern:/%.*$/gm},{name:"storage.function",pattern:/\\([A-Za-z@]+\*?|.)/g},{matches:{1:"entity.name.function",2:"entity.class"},pattern:/(\\(?:begin|end|documentclass))\s*\{([^\}]*)\}/g},{name:"entity.name.function",pattern:/\$.*?\$/g},{matches:{1:"entity.name.function",2:"tag"},pattern:/(\\(?:(?:sub)?paragraph|(?:sub){0,3}section|chapter|part)\*?)\{([^\}]*)\}/g},{name:"entity.name.function",pattern:/#./g},{matches:{1:"entity.name.function",2:"tag"},pattern:/(\\newcommand)\s*\{?(\\(?:[A-Za-z]*))\}?(?:\[\d\])?/g}],
!0);Rainbow.extend("c",[{name:"meta.preprocessor",matches:{1:[{matches:{1:"keyword.define",2:"entity.name"},pattern:/(\w+)\s(\w+)\b/g},{name:"keyword.define",pattern:/endif/g},{name:"constant.numeric",pattern:/\d+/g},{matches:{1:"keyword.include",2:"string"},pattern:/(include)\s(.*?)$/g}]},pattern:/\#([\S\s]*?)$/gm},{name:"keyword",pattern:/\b(do|goto|typedef)\b/g},{name:"entity.label",pattern:/\w+:/g},{matches:{1:"storage.type",3:"storage.type",4:"entity.name.function"},pattern:/\b((un)?signed|const)? ?(void|char|short|int|long|float|double)\*? +((\w+)(?= ?\())?/g},
{matches:{2:"entity.name.function"},pattern:/(\w|\*) +((\w+)(?= ?\())/g},{name:"storage.modifier",pattern:/\b(static|extern|auto|register|volatile|inline)\b/g},{name:"support.type",pattern:/\b(struct|union|enum)\b/g}]);Rainbow.extend("d",[{name:"constant",pattern:/\b(false|null|true)\b/gm},{name:"keyword",pattern:/\b(abstract|alias|align|asm|assert|auto|body|bool|break|byte|case|cast|catch|cdouble|cent|cfloat|char|class|const|continue|creal|dchar|debug|default|delegate|delete|deprecated|do|double|else|enum|export|extern|final|finally|float|for|foreach|foreach_reverse|function|goto|idouble|if|ifloat|immutable|import|in|inout|int|interface|invariant|ireal|is|lazy|long|macro|mixin|module|new|nothrow|null|out|override|package|pragma|private|protected|public|pure|real|ref|return|scope|shared|short|size_t|static|string|struct|super|switch|synchronized|template|this|throw|try|typedef|typeid|typeof|ubyte|ucent|uint|ulong|union|unittest|ushort|version|void|volatile|wchar|while|with|__FILE__|__LINE__|__gshared|__traits|__vector|__parameters)\b/gm},
...
!0);Rainbow.extend("plain-tex",[{name:"comment",pattern:/%.*$/gm},{name:"storage.function",pattern:/\\([A-Za-z@]+\*?|.)/g},{name:"string",pattern:/\$.*?\$/g}],!0);Rainbow.extend("r",[{matches:{1:{name:"keyword.operator",pattern:/\=|<\-|&lt;-/g},2:{name:"string",matches:{name:"constant.character.escape",pattern:/\\('|"){1}/g}}},pattern:/(\(|\s|\[|\=|:)(('|")([^\\\1]|\\.)*?(\3))/gm},{matches:{1:"constant.language"},pattern:/\b(NULL|NA|TRUE|FALSE|T|F|NaN|Inf|NA_integer_|NA_real_|NA_complex_|NA_character_)\b/g},{matches:{1:"constant.symbol"},pattern:/[^0-9a-zA-Z\._](LETTERS|letters|month\.(abb|name)|pi)/g},{name:"keyword.operator",pattern:/&lt;-|<-|-|==|&lt;=|<=|&gt;>|>=|<|>|&amp;&amp;|&&|&amp;|&|!=|\|\|?|\*|\+|\^|\/|%%|%\/%|\=|%in%|%\*%|%o%|%x%|\$|:|~|\[{1,2}|\]{1,2}/g},
