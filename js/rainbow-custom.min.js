/* Rainbow v1.2 rainbowco.de | included languages: latex, c, scheme, java, d, lua, generic, plain-tex, javascript, r, html, python, coffeescript, haskell, smalltalk, csharp, go, shell, php, ruby, css */
...
document.addEventListener?document.addEventListener("DOMContentLoaded",Rainbow.color,!1):window.attachEvent("onload",Rainbow.color);Rainbow.onHighlight=Rainbow.b;Rainbow.addClass=Rainbow.a;Rainbow.extend("latex",[{name:"comment",pattern:/%.*$/gm},{name:"storage.function",pattern:/\\([A-Za-z@]+\*?|.)/g},{matches:{1:"entity.name.function",2:"entity.class"},pattern:/(\\(?:begin|end|documentclass))\s*\{([^\}]*)\}/g},{name:"entity.name.function",pattern:/\$.*?\$/g},{matches:{1:"entity.name.function",2:"tag"},pattern:/(\\(?:(?:sub)?paragraph|(?:sub){0,3}section|chapter|part)\*?)\{([^\}]*)\}/g},{name:"entity.name.function",pattern:/#./g},{matches:{1:"entity.name.function",2:"tag"},pattern:/(?:(\\newcommand\s*\{?)(\\(?:[A-Za-z]*))\}?(?:\[\d])?/g}],
